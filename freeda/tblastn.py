...
def check_genome_downloads(ref_species, database_path, genome, zip=False):
    ...
    primates = {"HomoSapiens_genome": 3138414431,
             ...
             'PanPaniscus_genome': 3312469357,
             'GorillaGorilla_genome': 3083663602,
             'PongoAbelli_genome': 3103792067,
             'PongoPygmaeus_genome': 3290024527,
             'NomascusLeucogenys_genome': 2879637870,
             'NomascusSiki_genome': 2818036002,
             'HylobatesMoloch_genome': 2885571806,
             'HylobatesPileatus_genome': 2887024203,
             'SymphalangusSyndactylus_genome': 3222691930,
             'HoolockLeuconedys_genome': 2819995160,
...
def check_blast_database(genome, database_path):
    ...
    possible_databases = {
        ...
        'MusMusculus': [('MusMusculus_genome.fasta.ntf', 16284),
                           ('MusMusculus_genome.fasta.nto', 0),
                           ('MusMusculus_genome.fasta.not', 0),
                           ('MusMusculus_genome.fasta.ndb', 0),
                           ('MusMusculus_genome.fasta.nsq', 0),
                           ('MusMusculus_genome.fasta.nhr', 0),
                           ('MusMusculus_genome.fasta.nin', 0)],
