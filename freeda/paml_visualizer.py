...
def plot_paml(wdir, result_path, protein_name, nr_of_species_total, original_species):
    # get original and final aa sequence for a protein
    original_sequence_record, final_sequence_record = get_original_and_final_seqs(wdir, protein_name, result_path,
                                                                                  original_species)
    # organise them into easy to search dictionaries
    original_species_dict, final_original_species_dict, final_length = organise_original_and_final_seqs(
        original_sequence_record, final_sequence_record)
    # map the aa residues between the original and final sequnces
    mapped_original_and_final_residues_dict = map_original_and_final_residues(original_sequence_record,
    ...
    adaptive_sites_dict = get_adaptive_sites(result_path, protein_name)
    ...
    matched_adaptive_sites_original = match_adaptive_sites_to_original(final_original_species_dict,
                                                                       ...
                                                                       adaptive_sites_dict, omega_dict)
...
def match_adaptive_sites_to_original(final_original_species_dict,
                                     mapped_original_and_final_residues_dict,
                                     adaptive_sites_dict, omega_dict):
...
def get_adaptive_sites(result_path, protein_name):
    PAML_output_file_path = result_path + "/" + protein_name + "/PAML_" + protein_name
...
def record_adaptive_sites_old(final_dict_to_plot, protein_name):
    ...
    message = ("\n\n.........................................." \
            "\n\nReference sequence for %s with adaptive sites:" \
            " \n\n" + sequence_breakdown + "\n\n(* means pr > 0.50; "
            "** means pr > 0.90; [] means missing)") % protein_name
    print(message)
    logging.info(message)
