...
logging_frame = ttk.Frame(output_frame, relief="ridge", padding="3 3 3 3")
logging_frame.grid(column=0, row=0, columnspan=9, sticky=(N, W, E, S), padx=3, pady=3)
...
g1_results_frame = ttk.Frame(results_labelframe, relief="ridge", padding="3 3 3 3")
...
g2_results_frame = ttk.Frame(results_labelframe, relief="ridge", padding="3 3 3 3")
g2_results_frame.grid(column=0, row=5, columnspan=8, sticky=(N, W, E, S), padx=3, pady=3)
g2_results_frame.columnconfigure((0, 1, 2, 3, 4, 5, 6, 7), weight=1, uniform="group1")

# create user gene 3 result frame
g3_results_frame = ttk.Frame(results_labelframe, relief="ridge", padding="3 3 3 3")
g3_results_frame.grid(column=0, row=6, columnspan=8, sticky=(N, W, E, S), padx=3, pady=3)
g3_results_frame.columnconfigure((0, 1, 2, 3, 4, 5, 6, 7), weight=1, uniform="group1")

# create user gene 4 result frame
g4_results_frame = ttk.Frame(results_labelframe, relief="ridge", padding="3 3 3 3")
g4_results_frame.grid(column=0, row=7, columnspan=8, sticky=(N, W, E, S), padx=3, pady=3)
g4_results_frame.columnconfigure((0, 1, 2, 3, 4, 5, 6, 7), weight=1, uniform="group1")

# create user gene 5 result frame
g5_results_frame = ttk.Frame(results_labelframe, relief="ridge", padding="2 3 3 3")
g5_results_frame.grid(column=0, row=8, columnspan=8, sticky=(N, W, E, S), padx=3, pady=3)
